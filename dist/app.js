...
var AddASongElement = React.createClass({
  ...
  addNewSong: function addNewSong() {
  ...
  playOnceChanged: function playOnceChanged(e) {
    this.setState({ playOnce: !this.state.playOnce });
  },

  youtubeUrlChanged: function youtubeUrlChanged(e) {
  ...
  render: function render() {
    return React.createElement(
      ...
      { action: "#" },
      "Youtube url:",
      React.createElement("input", { id: "url", value: this.state.youtubeUrl, onChange: this.youtubeUrlChanged }),
      React.createElement("br", null),
      "Play only once ?",
      React.createElement("input", { id: "playonce", type: "checkbox", checked: this.state.playOnce, onClick: this.playOnceChanged }),
      React.createElement("br", null),
      React.createElement(
        "button",
